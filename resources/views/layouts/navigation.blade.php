<aside class="text-white">
    ...
    {{-- Sidebar --}}
    <div class="fixed inset-y-0 left-0 z-50 w-72 h-screen flex flex-col overflow-hidden transform transition-transform duration-300 ease-in-out"
        ...
        <div class="relative h-20 px-6 border-b border-white/10 flex items-center gap-4 backdrop-blur-sm">
            <a href="{{ route('dashboard') }}" class="shrink-0" @click="sidebarOpen = false">
                <div
        ...
        <div class="relative flex-1 min-h-0 overflow-y-auto px-4 py-5 space-y-6 sidebar-scroll">
            <div>
            ...
            <div>
                <p class="px-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-200/60 mb-2">Task System
                </p>
                <div class="space-y-1.5">

                    @can('view workspaces')
                        <a href="{{ route('workspaces.index') }}" @click="sidebarOpen = false"
                    ...
                    @can('view projects')
                        <a href="{{ route('projects.index') }}" @click="sidebarOpen = false"
                    ...
                    @can('view own tasks')
                        <a href="{{ route('tasks.my') }}" @click="sidebarOpen = false"
                    ...
                    @can('approve task extension')
                        <a href="{{ route('task-extension-requests.index') }}" @click="sidebarOpen = false"
                    ...
                    @can('view task reports')
                        <a href="{{ route('task-reports.index') }}" @click="sidebarOpen = false"
                    ...
                    <a href="{{ route('task-reports.my') }}" @click="sidebarOpen = false"
            ...
            <div>
                <p class="px-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-200/60 mb-2">Office & HR
                </p>
                <div class="space-y-1.5">
                    @can('view employees')
                        <a href="{{ route('employees.index') }}" @click="sidebarOpen = false"
                    ...
                    @can('view attendance')
                        @if(feature_enabled('attendance_module_enabled'))
                            <a href="{{ route('attendances.index') }}" @click="sidebarOpen = false"
                    ...
                    @can('view leave requests')
                        @if(feature_enabled('leave_module_enabled'))
                            <a href="{{ route('leave-requests.index') }}" @click="sidebarOpen = false"
                    ...
                    @can('view leave types')
                        @if(feature_enabled('leave_module_enabled'))
                            <a href="{{ route('leave-types.index') }}" @click="sidebarOpen = false"
                    ...
                    @can('view office settings')
                        <a href="{{ route('office-settings.edit') }}" @click="sidebarOpen = false"
            ...
            <div>
                <p class="px-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-200/60 mb-2">CRM &
                    Marketing</p>
                <div class="space-y-1.5">
                    @can('view leads')
                        @if(feature_enabled('lead_module_enabled'))
                            <a href="{{ route('leads.index') }}" @click="sidebarOpen = false"
                    ...
                    @if(!$isAdmin)
                        @can('view own leads')
                            @if(feature_enabled('lead_module_enabled'))
                                <a href="{{ route('leads.my') }}" @click="sidebarOpen = false"
                    ...
                    @can('view campaigns')
                        @if(feature_enabled('campaign_module_enabled'))
                            <a href="{{ route('email-campaigns.index') }}" @click="sidebarOpen = false"
                    ...
                    @can('view ai history')
                        @if(feature_enabled('ai_module_enabled'))
                            <a href="{{ route('ai-generations.index') }}" @click="sidebarOpen = false"
            ...
            @if(!$isAdmin)
                <div>
                    <p class="px-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-200/60 mb-2">Self Service
                    </p>
                    <div class="space-y-1.5">
                        @if($isEmployee)
                            <a href="{{ route('profile.employee') }}" @click="sidebarOpen = false"
                            ...
                            @if(feature_enabled('attendance_module_enabled'))
                                <a href="{{ route('profile.attendance') }}" @click="sidebarOpen = false"
                        ...
                        @can('mark self attendance')
                            @if(feature_enabled('attendance_module_enabled'))
                                <a href="{{ route('profile.checkin.form') }}" @click="sidebarOpen = false"
                        ...
                        @can('mark self checkout')
                            @if(feature_enabled('attendance_module_enabled'))
                                <a href="{{ route('profile.checkout.form') }}" @click="sidebarOpen = false"
                        ...
                        @can('apply leave')
                            @if(feature_enabled('leave_module_enabled'))
                                <a href="{{ route('leave-requests.my') }}" @click="sidebarOpen = false"
                        ...
                        @can('view own leave balance')
                            @if(feature_enabled('leave_module_enabled'))
                                <a href="{{ route('leave-requests.balance') }}" @click="sidebarOpen = false"
                        ...
                        @can('view own bank account')
                            <a href="{{ route('bank-account.my') }}" @click="sidebarOpen = false"
                        ...
                        @can('view own salary payments')
                            <a href="{{ route('salary-payments.my') }}" @click="sidebarOpen = false"
            ...
            <div>
                ...
                <div class="space-y-1.5">
                    @can('view attendance reports')
                        @if(feature_enabled('attendance_module_enabled'))
                            <a href="{{ route('reports.attendance') }}" @click="sidebarOpen = false"
                    ...
                    @can('view lead reports')
                        @if(feature_enabled('lead_module_enabled'))
                            <a href="{{ route('reports.leads') }}" @click="sidebarOpen = false"
                    ...
                    @can('view campaign reports')
                        @if(feature_enabled('campaign_module_enabled'))
                            <a href="{{ route('reports.email-campaigns') }}" @click="sidebarOpen = false"
                    ...
                    @can('view leave reports')
                        @if(feature_enabled('leave_module_enabled'))
                            <a href="{{ route('reports.leaves') }}" @click="sidebarOpen = false"
