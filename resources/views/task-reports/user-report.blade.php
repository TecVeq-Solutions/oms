        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white shadow rounded-xl p-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">{{ $user->name }} - Task Report</h2>

                    <form method="GET" action="{{ route('task-reports.user', $user) }}" class="flex items-end gap-3">
                        <div>
            ...
            <div class="bg-white shadow rounded-xl p-6">
                ...
                @else
                    <div class="rounded-lg bg-yellow-100 text-yellow-800 px-4 py-3">
                        No tasks found for this user report.
                    </div>
                @endif
            </div>
        </div>
